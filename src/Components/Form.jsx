...
const Form = () => {
  ...
  const onSubmitForm = (e) => {
    ...
    if(!isNameValid || !isEmailValid) {
      setMessage("Please, make sure your information is correct. Names should have more than 5 characters.");
    }
    else {
      setMessage(`Thank you ${name}, we'll contact you as soon as possible by e-mail`);
